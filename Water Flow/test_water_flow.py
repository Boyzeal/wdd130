...
def test_water_column_height():
    assert water_column_height(0.0, 0.0) == pytest.approx(0.0)
    assert water_column_height(0.0, 10.0) == pytest.approx(7.5)
    assert water_column_height(25.0, 0.0) == pytest.approx(25.0)
    assert water_column_height(48.3, 12.8) == pytest.approx(57.9)
